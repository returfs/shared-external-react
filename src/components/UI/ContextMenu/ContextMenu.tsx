...
import { CaretLeft, Check, Dot } from '@phosphor-icons/react';
...
>(({ className, inset, children, ...props }, ref) => (
  ...
  >
    {children}
    <CaretLeft className="ml-auto h-4 w-4" />
  </ContextMenuPrimitive.SubTrigger>
));
...
>(({ className, inset, ...props }, ref) => (
  <ContextMenuPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex h-[30px] cursor-default select-none items-center rounded-lg px-2 py-1.5 text-sm outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
      focusNeutralOneHundredSevenHundredBgColors,
      inset && 'pl-8',
      className,
    )}
